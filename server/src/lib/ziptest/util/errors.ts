...
type ErrorFunction = (...args: string[]) => Error;
interface ErrorExports {
    [key: string]: ErrorFunction;
}

// template
function E(message: string): ErrorFunction {
    return function (...args: string[]): Error {
...
const Errors: ErrorExports = {};

// Init errors with template
for (const msg of Object.keys(errors)) {
    Errors[msg] = E(errors[msg]);
}

export { errors, ErrorExports, Errors }; 
